...
`history.ts` provides two pieces:
...
| partition healing | convergence | later completed reads do not regress | pending |
| crash before write completion | completion honesty | no fabricated completion | pending |
